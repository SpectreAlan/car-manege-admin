<template>
  <div class="login-container">
    <el-form ref="form" :model="form" :rules="rules" class="login-form" autocomplete="on" label-position="left">
      ...
      <el-button :loading="loading" type="primary" style="width:100%;margin-bottom:30px;" @click.native.prevent="login">立即登录</el-button>
    </el-form>
  </div>
</template>
...
export default {
  ...
  created() {
    ...
    this.bg = 'image-base-url/blog/cover/' + day + '.jpg'
