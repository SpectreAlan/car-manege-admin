<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      <el-input v-model.trim="listQuery.account" size="mini" placeholder="账号..." style="width: 200px;" clearable />
      <el-button size="mini" type="primary" class="filter-item" @click="search()">查询</el-button>
      <el-button size="mini" type="success" class="filter-item" @click="handleAdd()">添加</el-button>
    </div>
    <!-- 表格区域 -->
    ...
    <!-- 新增/编辑-->
    <el-dialog :title="title" :visible.sync="dialogVisible" :width="w + 'px'">
