<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      <el-input v-model.trim="listQuery.role_name" size="mini" placeholder="角色名称" style="width: 200px;" class="filter-item" clearable />
    ...
    <!-- 新增 -->
    <el-dialog :visible.sync="dialogVisible" :title="title" :width="w + 'px'">
