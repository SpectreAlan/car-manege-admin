<template>
  <div class="app-container">
    <div class="filter-container">
      <el-button size="mini" type="success" class="filter-item" @click="handleAdd()">添加发货单位</el-button>
    </div>
    <!-- 表格区域 -->
...
<script>
import { list, del, edit } from '@/api/delivery'
...
export default {
  ...
  data() {
    return {
      ...
      tableHeader: [
        { field: 'delivery', sortable: 'custom', title: '单位名称' },
        { field: 'contact', sortable: 'custom', title: '联系人' },
        { field: 'phone', sortable: 'custom', title: '联系电话' },
