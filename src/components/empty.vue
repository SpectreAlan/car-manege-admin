<template>
  <div v-if="!list.length" class="empty" :style="{height}">
    <h3>{{ title }}</h3>
    <svg
      viewBox="0 0 79 86"
      version="1.1"
    ...
    >
      <defs>
        ...
        <rect id="path-3-7" x="0" y="0" width="17" height="36" />
      </defs>
      <g id="Illustrations" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <g id="B-type" transform="translate(-1268.000000, -535.000000)">
          <g id="Group-2" transform="translate(1268.000000, 535.000000)">
            ...
            <rect id="Rectangle-Copy-15" fill="url(#linearGradient-2-7)" x="13" y="45" width="40" height="36" />
            <g id="Rectangle-Copy-17" transform="translate(53.000000, 45.000000)">
              <mask id="mask-4-7" fill="white">
                <use xlink:href="#path-3-7" />
              </mask>
              <use
                id="Mask"
                fill="#E0E3E9"
